...
var ContributionRewardExtPlugin = /** @class */ (function (_super) {
    __extends(ContributionRewardExtPlugin, _super);
    function ContributionRewardExtPlugin() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ContributionRewardExtPlugin.itemMap = function (context, item, queriedId) {
        if (!item) {
            index_1.Logger.debug("ContributionRewardExtPlugin ItemMap failed. " + (queriedId && "Could not find ContributionRewardExtPlugin with id '" + queriedId + "'"));
            return null;
        }
    ...
    ContributionRewardExtPlugin.prototype.createProposalTransaction = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!options.proposer) {
                            options.proposer = index_1.NULL_ADDRESS;
                        }
                        _a = options;
    ...
    ContributionRewardExtPlugin.prototype.createProposalTransactionMap = function () {
        var _this = this;
        return function (receipt) {
            var args = index_1.getEventArgs(receipt, 'NewContributionProposal', 'ContributionRewardExt.createProposal');
            var proposalId = args[1];
            return new index_1.ContributionRewardExtProposal(_this.context, proposalId);
        };
    };
    ContributionRewardExtPlugin.prototype.ethBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ContributionRewardExtPlugin.fragment = {
    ...
    return ContributionRewardExtPlugin;
}(index_1.ProposalPlugin));
exports.ContributionRewardExtPlugin = ContributionRewardExtPlugin;
